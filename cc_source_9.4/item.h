...
Item *idItem (char *name, attrib *ap=NULL);
Item *ptrItem(void *p);
Item *immdItem(char *str, attrib *ap);
Item *tmpItem(int index, attrib *ap=NULL);
...
#define IS_TEMP(ip,idx)		(ip->type == TEMP_ITEM && ip->val.i == idx)
