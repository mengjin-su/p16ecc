...
#define __DEVICE    "p16f15213"
#include <pic16e.h>

#define __FLASH_SIZE        2048
#define __SRAM_SIZE         255
...
#define FUSE2			0x8008
	...
	#define _PPS1WAY_1		0x3fff	// bit11
	#define _PPS1WAY_0		0x37ff	// bit11
	#define _BORV_285V		0x3dff	// bit9 brown out = 2.85v
	#define _BORV_190V		0x3fff	// bit9 brown out = 1.90v
	#define _BOREN_IGNORE	0x3fff	// bit7-6
	#define _BOREN_RUNNING	0x3fbf	// bit7-6
	#define _BOREN_SBOREN	0x3f7f	// bit7-6
	#define _BOREN_DISABLE	0x3f3f	// bit7-6
	#define _WDT_ENABLED	0x3fff	// bit4-3
	#define _WDT_SLEEP		0x3ff7	// bit4-3
	#define _WDT_BY_SEN		0x3fef	// bit4-3
	#define _WDT_DISABLED	0x3fe7	// bit4-3
	#define _PWRTS_DISABLED	0x3fff	// bit2-1
	#define _PWRTS_64MS		0x3ffb	// bit2-1
	#define _PWRTS_16MS		0x3ffd	// bit2-1
	#define _PWRTS_1MS		0x3ff9	// bit2-1
	#define _MCLRE_IS_MCLRE	0x3fff	// bit0
	#define _MCLRE_IS_PORT	0x3ffe	// bit0
#define FUSE3			0x8009
#define FUSE4			0x800a
#define FUSE5			0x800b
