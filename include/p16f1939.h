...
#define __DEVICE    "p16f1939"
#include <pic16e.h>

#define __FLASH_SIZE        1024*16	// words
#define __SRAM_SIZE         1024	// bytes
...
#define ANSELD				REG8(0x0f | _BK3)
#define ANSELE				REG8(0x10 | _BK3)
...
#define SPBRG				REG16(0x1b | _BK3)
#define RCSTA				REG8(0x1d | _BK3)
#define TXSTA				REG8(0x1e | _BK3)
#define BAUDCTR				REG8(0x1f | _BK3)

#define WPUB				REG8(0x0c | _BK4)
...
sbit CCP5IF				@	(&PIR3 << 3) | 6;
sbit CCP4IF				@	(&PIR3 << 3) | 5;
sbit CCP3IF				@	(&PIR3 << 3) | 4;
sbit TMR6IF				@	(&PIR3 << 3) | 3;
sbit TMR4IF				@	(&PIR3 << 3) | 1;
