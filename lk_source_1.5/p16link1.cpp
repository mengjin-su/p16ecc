...
int P16link :: scanLibInclusion(void)
{
	...
	do {
		...
		logSegSymbols(codeSegGroup, &symList, 0);
		logSegSymbols(dataSegGroup, &symList, 0);
		logSegSymbols(miscSegGroup, &symList, 0);
...
void P16link :: logSegSymbols(Segment *seglist, Symbol **symlist, int mode)
{
